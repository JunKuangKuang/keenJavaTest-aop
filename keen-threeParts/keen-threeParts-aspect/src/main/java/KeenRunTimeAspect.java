...
// import xyz.clzly.component.log.xyz.clzly.utils.LoggingUtils;
...
//                 date = new Date();
//                 //运行 函数并打印日志
//                 if (xyz.clzly.utils.LoggingUtils.isInfoEnabled()) {
//                     xyz.clzly.utils.LoggingUtils.info(declaringType, "【方法名为：】{},【开始运行时间为：】{}",
//                             new Object[]{methodName, matter.format(date)});
//                 }
//                 result = point.proceed();
//                 if (xyz.clzly.utils.LoggingUtils.isInfoEnabled()) {
//                     xyz.clzly.utils.LoggingUtils.info(declaringType, "【方法名为：】{},【运行时长为：】{}",
//                             new Object[]{methodName, System.currentTimeMillis() - date.getTime() +
//                                     "ms"});
//                 }
//             } catch (Throwable throwable) {
//                 xyz.clzly.utils.LoggingUtils.error(method.getDeclaringClass(), "【方法名为：】:{},【入参：】：{}, " +
